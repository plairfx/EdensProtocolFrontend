...
export async function loadFromFile(params) {
  const csvData = readFileSync(
    "/home/administrator/frontend-EP/edenfrontend/edenindexer/generated_csv/EdenPL/edenpl-deposited.csv",
    "utf8"
  );
  const csvData2 = readFileSync(
    "/home/administrator/frontend-EP/edenfrontend/edenindexer/generated_csv/EdenPLLINK/edenpllink-deposited.csv",
    "utf8"
  );
